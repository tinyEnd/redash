...
REDIS_URL = os.environ.get('REDASH_REDIS_URL', os.environ.get('REDIS_URL', ""))
...
SQLALCHEMY_DATABASE_URI = os.environ.get("REDASH_DATABASE_URL", os.environ.get('DATABASE_URL', ""))
